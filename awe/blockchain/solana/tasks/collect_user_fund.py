...
def collect_user_fund(user_wallet: str, agent_creator_wallet: str, amount: int) -> str:
    ...
    pool_amount = amount - agent_creator_amount

    logger.info(f"collecting user payment: {user_wallet}: {amount}, agent creator: {agent_creator_wallet}, pool: {pool_amount}, creator: {agent_creator_amount}")
